...
<body>
  <header>
    <img src="/assets/images/logo.svg" alt="LibreSpeed" />
  </header>
  <main>
  ...
  <a id="design-switcher-btn" href="#" style="
  ...
  ">Ganti ke UI Classic</a>

  <script>
  (function() {
      var KEY = 'design_preference';
      var btn = document.getElementById('design-switcher-btn');

      // Sync localStorage to cookie on page load
      var stored = localStorage.getItem(KEY);
      if (stored && stored !== getCookie(KEY)) {
